...
import { Act, Vibe, Role, Participant, GameState, Cocktail, Confession } from './types';
import { THE_GENTS, MOCK_GUESTS, ROOM_CODES, INITIAL_SCENE } from './constants';
...
const App = () => {
  ...
  // renderWrapped removed — extracted to WrappedView component below
